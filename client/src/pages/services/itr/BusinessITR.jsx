        ...
        <div className="max-w-[1024px] mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {businessServices.map((service, index) => {
              ...
              return (
                <div key={index} className="bg-white rounded-3xl shadow-xl border border-slate-200 p-6 hover:shadow-2xl transition-all duration-300 hover:-translate-y-2 flex flex-col">
                  <div className="text-center mb-6">
                    ...
                    <p className="text-slate-600 mb-3 text-xs">{service.description}</p>
                    <div className="text-2xl font-extrabold text-slate-900 mb-4">{service.price}</div>
                  </div>
